  ...
  return (
    <DialogPortal data-slot='dialog-portal'>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          fullscreen
            ? 'fixed inset-0 z-50 w-[85vw] h-[85vh] max-w-none max-h-none translate-x-0 translate-y-0 rounded-none border-none p-0 shadow-none'
      ...
      >
        ...
        {title && (
          <div className="flex justify-between items-center px-6 py-4 border-b bg-gray-50">
            ...
            {showCloseButton && (
              <DialogPrimitive.Close className="text-gray-500 hover:text-gray-700 transition">
                <XIcon />
